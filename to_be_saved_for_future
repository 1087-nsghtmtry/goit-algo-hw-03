...
def get_upcoming_birthdays(users, days=7):
    ...
    for user in users:
        ...
        if (birthday_this_year - today).days < 0:
            #print((birthday_this_year - today).days)
            birthday_this_year = birthday_this_year.replace(today.year + 1)
            
        print(birthday_this_year, "congrats_day: ", birthday_this_year.weekday())
